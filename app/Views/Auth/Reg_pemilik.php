                ...
                <div class="card-body">
                    ...
                    <div class="p-3">
                        ...
                        <?=csrf_field();?>
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="form-control" name="no_hp" id="no_hp" type="number" required="" placeholder="Nomor Handphone">
                            ...
                            <div class="form-group text-center row m-t-20">
                                <div class="col-12">
                                    <button class="btn btn-primary btn-block waves-effect waves-light btn-simpan" type="submit">Registrasi</button>
                                </div>
                            </div>
