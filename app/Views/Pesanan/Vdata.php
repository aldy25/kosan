...
<div class="col-sm-12">
    <div class="page-title-box">
        <h4 class="page-title">Data Pesanan Kosan</h4>
    </div>
</div>
<div class="col-sm-12">
    ...
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Ubah Status Verifikasi</h5>
            ...
            <div class="modal-body" id="modal-d">
                <div class="form-group row" style="display: none;">
                    <div class="col-sm-8">
                        <input type="text" name="kosan" id="kosan" class="form-control">        
                    </div>
                </div>
                <div class="form-group row" style="display: none;">
                    <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label style=" color:black;" for="status" class="col-sm-2 col-form-label">Status Verifikasi </label>
                <div class="col-sm-8">
                        <select name="status" id="stat" class="form-control">
                            <option style="color:black;" value="">--Pilih--</option>
                            <option style="color:black;" value="Sudah Terverifikasi">Sudah Terverifikasi</option>
                            <option style="color:black;" value="Belum Terverifikasi">Belum Terverifikasi</option>
                        </select>
...
<script>
    function dataAdmin(){
        $.ajax({
            url:"<?=Base_url('datatabel_pesanan')?>",
            dataType: "json",
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#edit', function(){
            $('#modal-d #id_pesanan').val($(this).data('id_pesanan'));
            $('#modal-d #kosan').val($(this).data('kosan'));
        });
        ...
        $('.formupdate').submit(function(e){
            ...
            $.ajax({
                type: "post",
                url: "<?=base_url('Update_status_pesanan')?>",
                data:data,
                processData:false,
                contentType:false,
                cache:false,
